...
Spark - 0.9.1-bin-hadoop2+, 0.9.2-bin-hadoop2+, 1.0.0-bin-hadoop2^,
        ...
        1.3.1-bin-hadoop2.3+, 1.3.1-bin-hadoop2.4+, 1.3.1-bin-hadoop2.6+,
        1.4.0-bin-hadoop2.6+, 1.4.1-bin-hadoop2.6+,
        1.5.0-bin-hadoop2.6+, 1.5.1-bin-hadoop2.6+,
        1.5.2-bin-hadoop2.6+, 1.6.0-bin-hadoop2.6+,
        1.6.1-bin-hadoop2.6+, 1.6.2-bin-hadoop2.6+,
