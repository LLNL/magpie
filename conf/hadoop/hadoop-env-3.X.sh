...
export HADOOP_OPTS="$HADOOP_OPTS -Djava.net.preferIPv4Stack=true -Dsun.security.krb5.debug=true -Dsun.security.spnego.debug $EXTRA_HADOOP_OPTS"
...
# this is the default:
export HDFS_NAMENODE_OPTS="-XmxHADOOP_NAMENODE_HEAP_MAXm -Dhadoop.security.logger=INFO,RFAS"
...
#
# This is the default:
export HDFS_SECONDARYNAMENODE_OPTS="-XmxHADOOP_DAEMON_HEAP_MAXm -Dhadoop.security.logger=INFO,RFAS"
...
#
# This is the default:
export HDFS_DATANODE_OPTS="-XmxHADOOP_DAEMON_HEAP_MAXm -Dhadoop.security.logger=ERROR,RFAS"
