...
SubmitHbaseDependencyTests() {
	...
	do
	    for zookeeperversion in 3.4.6
	    do
		SubmitHbaseDependencyTests_Dependency1 ${hbaseversion} ${hadoopversion} ${zookeeperversion}
	    done
	done
    done
	...
	do
	    for zookeeperversion in 3.4.6
	    do
		SubmitHbaseDependencyTests_Dependency2 ${hbaseversion} ${hadoopversion} ${zookeeperversion}
	    done
	done
    done
