...
hadoop2Xjava17versions="2.6.0 2.6.1 2.6.2 2.6.3 2.6.4 2.6.5 2.7.0 2.7.1 2.7.2 2.7.3 2.8.0 2.8.1"
...
hbasehadoop27zookeeper34java17versions="0.99.0 0.99.1 0.99.2 1.0.0 1.0.1 1.0.1.1 1.0.2 1.0.3 1.1.0 1.1.0.1 1.1.1 1.1.2 1.1.3 1.1.4 1.1.5 1.1.6 1.1.7 1.1.8 1.1.9 1.2.0 1.2.1 1.2.2 1.2.3 1.2.4 1.2.5 1.2.6 1.3.0 1.3.1"
hbasehadoop27zookeeper34java17versions_hadoopversion="2.7.0"
hbasehadoop27zookeeper34java17versions_zookeeperversion="3.4.10"
...
phoenixhbase10hadoop27zookeeper34java17versions_zookeeperversion="3.4.10"
phoenixhbase10hadoop27zookeeper34java17versions_javaversion=${java17}

phoenixhbase11hadoop27zookeeper34java17versions="4.5.0-HBase-1.1 4.5.1-HBase-1.1 4.5.2-HBase-1.1 4.6.0-HBase-1.1 4.7.0-HBase-1.1 4.8.0-HBase-1.1 4.8.1-HBase-1.1 4.8.2-HBase-1.1 4.9.0-HBase-1.1 4.10.0-HBase-1.1 4.11.0-HBase-1.1"
...
phoenixhbase11hadoop27zookeeper34java17versions_zookeeperversion="3.4.10"
phoenixhbase11hadoop27zookeeper34java17versions_javaversion=${java17}

phoenixhbase12hadoop27zookeeper34java17versions="4.8.0-HBase-1.2 4.8.1-HBase-1.2 4.8.2-HBase-1.2 4.9.0-HBase-1.2 4.10.0-HBase-1.2 4.11.0-HBase-1.2"
...
phoenixhbase12hadoop27zookeeper34java17versions_zookeeperversion="3.4.10"
phoenixhbase12hadoop27zookeeper34java17versions_javaversion=${java17}

phoenixhbase13hadoop27zookeeper34java17versions="4.11.0-HBase-1.3"
...
phoenixhbase13hadoop27zookeeper34java17versions_zookeeperversion="3.4.10"
...
spark2Xjava18hadoop26versions="2.2.0-bin-hadoop2.6"
spark2Xjava18hadoop26versions_hadoopversion="2.6.0"
spark2Xjava18hadoop26versions_javaversion=${java18}
spark2Xjava18hadoop27versions="2.2.0-bin-hadoop2.7"
...
stormzookeeper34java17versions="0.9.5 0.9.6 0.9.7 0.10.0 0.10.1 0.10.2 1.0.0 1.0.1 1.0.2 1.0.3 1.0.4 1.1.0"
stormzookeeper34java17versions_zookeeperversion="3.4.10"
...
kafkazookeeper34java17versions_zookeeperversion="3.4.10"
...
zookeeperjava17versions="3.4.0 3.4.1 3.4.2 3.4.3 3.4.4 3.4.5 3.4.6 3.4.7 3.4.8 3.4.9 3.4.10"
...
zeppelinspark15java17versions="0.5.6-incubating"
zeppelinspark15java17versions_sparkversion="1.5.0-bin-hadoop2.6"
zeppelinspark15java17versions_javaversion="${java17}"
zeppelinspark16java17versions="0.6.0 0.6.1 0.6.2 0.7.0 0.7.1 0.7.2"
zeppelinspark16java17versions_sparkversion="1.6.0-bin-hadoop2.6"
zeppelinspark16java17versions_javaversion="${java17}"

zeppelin_test_groups="zeppelinspark15java17versions zeppelinspark16java17versions"
zeppelin_all_versions="${zeppelinspark15java17versions} ${zeppelinspark16java17versions}"
