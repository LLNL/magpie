...
# Spark 0.9.1, 1.2.0-bin-hadoop2.4, 1.3.0-bin-hadoop2.4, 1.4.1-bin-hadoop2.6
...
sed -i -e 's/export MAGPIE_JOB_TYPE="storm"/export MAGPIE_JOB_TYPE="zookeeper"/' magpie.${submissiontype}-zookeeper
sed -i -e 's/export ZOOKEEPER_MODE="launch"/export ZOOKEEPER_MODE="zookeeperruok"/' magpie.${submissiontype}-zookeeper
...
sed -i -e 's/export MAGPIE_JOB_TYPE="storm"/export MAGPIE_JOB_TYPE="zookeeper"/' magpie.${submissiontype}-zookeeper-no-local-dir
sed -i -e 's/export ZOOKEEPER_MODE="launch"/export ZOOKEEPER_MODE="zookeeperruok"/' magpie.${submissiontype}-zookeeper-no-local-dir
...
do
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-multiple-paths
    ...
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-localstore
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-localstore-multiple-paths

    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-no-local-dir
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-no-local-dir
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-multiple-paths-no-local-dir
    ...
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-localstore-no-local-dir
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop magpie.${submissiontype}-hadoop-${hadoopversion}-localstore-multiple-paths-no-local-dir
    ...
    sed -i -e 's/export HADOOP_FILESYSTEM_MODE="hdfsoverlustre"/export HADOOP_FILESYSTEM_MODE="hdfs"/' magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-no-local-dir magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-multiple-paths*

    sed -i -e 's/# export HADOOP_HDFS_PATH_CLEAR="yes"/export HADOOP_HDFS_PATH_CLEAR="yes"/' magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-no-local-dir magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-multiple-paths

    sed -i -e 's/export HADOOP_HDFS_PATH="'"${ssddirpathsubst}"'\/hdfs"/export HADOOP_HDFS_PATH="'"${ssddirpathsubst}"'\/a,'"${ssddirpathsubst}"'\/b,'"${ssddirpathsubst}"'\/c"/' magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-multiple-paths*

    sed -i -e 's/export HADOOP_FILESYSTEM_MODE="hdfsoverlustre"/export HADOOP_FILESYSTEM_MODE="hdfsovernetworkfs"/' magpie.${submissiontype}-hadoop-${hadoopversion}-hdfsovernetworkfs*

    sed -i -e 's/# export HADOOP_LOCALSTORE="'"${ssddirpathsubst}"'\/localstore\/"/export HADOOP_LOCALSTORE="'"${ssddirpathsubst}"'\/localstore\/"/' magpie.${submissiontype}-hadoop-${hadoopversion}-localstore magpie.${submissiontype}-hadoop-${hadoopversion}-localstore-no-local-dir

    sed -i -e 's/# export HADOOP_LOCALSTORE="'"${ssddirpathsubst}"'\/localstore\/"/export HADOOP_LOCALSTORE="'"${ssddirpathsubst}"'\/localstore\/a,'"${ssddirpathsubst}"'\/localstore\/b,'"${ssddirpathsubst}"'\/localstore\/c"/' magpie.${submissiontype}-hadoop-${hadoopversion}-localstore-multiple-paths*

    sed -i -e 's/# export HADOOP_TERASORT_SIZE=50000000/export HADOOP_TERASORT_SIZE=10000000000/' magpie.${submissiontype}-hadoop-${hadoopversion}*largeperformancerun
...
do
    ...
    sed -i -e 's/export HADOOP_FILESYSTEM_MODE="hdfsoverlustre"/export HADOOP_FILESYSTEM_MODE="hdfs"/' magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-multiple-paths

    sed -i -e 's/# export HADOOP_HDFS_PATH_CLEAR="yes"/export HADOOP_HDFS_PATH_CLEAR="yes"/' magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-multiple-paths

    sed -i -e 's/export HADOOP_HDFS_PATH="'"${ssddirpathsubst}"'\/"/export HADOOP_HDFS_PATH="'"${ssddirpathsubst}"'\/a,'"${ssddirpathsubst}"'\/b,'"${ssddirpathsubst}"'\/c"/' magpie.${submissiontype}-hadoop-${hadoopversion}-hdfs-multiple-paths

    sed -i -e 's/export HADOOP_FILESYSTEM_MODE="hdfsoverlustre"/export HADOOP_FILESYSTEM_MODE="hdfsovernetworkfs"/' magpie.${submissiontype}-hadoop-${hadoopversion}-hdfsovernetworkfs

    sed -i -e 's/# export HADOOP_LOCALSTORE="'"${ssddirpathsubst}"'\/localstore\/"/export HADOOP_LOCALSTORE="'"${ssddirpathsubst}"'\/localstore\/"/' magpie.${submissiontype}-hadoop-${hadoopversion}-localstore
...
sed -i \
    -e 's/export HADOOP_VERSION="\(.*\)"/export HADOOP_VERSION="2.6.0"/' \
    -e 's/export HADOOP_FILESYSTEM_MODE="hdfsoverlustre"/export HADOOP_FILESYSTEM_MODE="hdfsovernetworkfs"/' \
...
do
    for hadoopversion in 2.7.1
    do
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop-and-pig ./magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop-and-pig ./magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}-pig-script
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop-and-pig ./magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}-no-local-dir
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hadoop-and-pig ./magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}-pig-script-no-local-dir

	sed -i -e 's/export HADOOP_VERSION="\(.*\)"/export HADOOP_VERSION="'"${hadoopversion}"'"/' magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}*

	sed -i -e 's/export PIG_VERSION="\(.*\)"/export PIG_VERSION="'"${pigversion}"'"/' magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}*

	sed -i -e 's/export MAGPIE_JOB_TYPE="pig"/export MAGPIE_JOB_TYPE="script"/' ./magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}*pig-script*

	sed -i -e 's/# export MAGPIE_SCRIPT_PATH="\${HOME}\/my-job-script"/export MAGPIE_SCRIPT_PATH="'"${magpiescriptshomesubst}"'\/testsuite\/mytestpig.sh"/' ./magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}*pig-script*

	sed -i -e 's/export JAVA_HOME="\(.*\)"/export JAVA_HOME="\/usr\/lib\/jvm\/jre-1.7.0-oracle.x86_64\/"/' magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}*
    done
done
...
do
	...
	sed -i -e 's/export JAVA_HOME="\(.*\)"/export JAVA_HOME="\/usr\/lib\/jvm\/jre-1.6.0-sun.x86_64\/"/' magpie.${submissiontype}-hadoop-and-pig-${pigversion}-hadoop-${hadoopversion}*
    done
done
...
do
	...
	do
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-zookeeper-local
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-zookeeper-shared
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-zookeeper-shared-zookeeper-local
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-random-thread
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-random-thread-zookeeper-local
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-random-thread-zookeeper-shared
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-random-thread-zookeeper-shared-zookeeper-local

	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-no-local-dir
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-zookeeper-local-no-local-dir
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-zookeeper-shared-no-local-dir
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-zookeeper-shared-zookeeper-local-no-local-dir
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-random-thread-no-local-dir
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-random-thread-zookeeper-local-no-local-dir
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-random-thread-zookeeper-shared-no-local-dir
	    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}-random-thread-zookeeper-shared-zookeeper-local-no-local-dir
	    
	    sed -i -e 's/export HADOOP_VERSION="\(.*\)"/export HADOOP_VERSION="'"${hadoopversion}"'"/' magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}*
	    sed -i -e 's/export HBASE_VERSION="\(.*\)"/export HBASE_VERSION="'"${hbaseversion}"'"/' magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}*
	    sed -i -e 's/export ZOOKEEPER_VERSION="\(.*\)"/export ZOOKEEPER_VERSION="'"${zookeeperversion}"'"/' magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}*
	    ...
	    sed -i -e 's/export ZOOKEEPER_DATA_DIR="'"${lustredirpathsubst}"'\/zookeeper"/export ZOOKEEPER_DATA_DIR="'"${ssddirpathsubst}"'\/zookeeper\/"/' magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}*zookeeper-local*
	    ...
	    sed -i -e 's/export JAVA_HOME="\(.*\)"/export JAVA_HOME="\/usr\/lib\/jvm\/jre-1.7.0-oracle.x86_64\/"/' magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}*
	done
    done
done
...
do
	...
	do
	    ...
	    sed -i -e 's/export JAVA_HOME="\(.*\)"/export JAVA_HOME="\/usr\/lib\/jvm\/jre-1.6.0-sun.x86_64\/"/' magpie.${submissiontype}-hbase-with-hdfs-${hbaseversion}-hadoop-${hadoopversion}-zookeeper-${zookeeperversion}*
	done
    done
done
...
cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-hbase-with-hdfs ./magpie.${submissiontype}-hbase-with-hdfs-DependencyHbase1AD-hadoop-2.7.1-hbase-1.1.2-zookeeper-3.4.6
...
sed -i \
    ...
    -e 's/export ZOOKEEPER_DATA_DIR="\(.*\)"/export ZOOKEEPER_DATA_DIR="'"${lustredirpathsubst}"'\/zookeeper\/DEPENDENCYPREFIX\/Hbase1AD"/' \
    -e 's/export JAVA_HOME="\(.*\)"/export JAVA_HOME="\/usr\/lib\/jvm\/jre-1.7.0-oracle.x86_64\/"/' \
    ./magpie.${submissiontype}-hbase-with-hdfs-DependencyHbase1AD-hadoop-2.7.1-hbase-1.1.2-zookeeper-3.4.6
...
do
    ...
    sed -i -e 's/export HADOOP_FILESYSTEM_MODE="hdfsoverlustre"/export HADOOP_FILESYSTEM_MODE="rawnetworkfs"/' ./magpie.${submissiontype}-spark-with-rawnetworkfs-${sparkversion}*
...
do
    for zookeeperversion in 3.4.5 3.4.6
    do
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-storm magpie.${submissiontype}-storm-${stormversion}-zookeeper-${zookeeperversion}
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-storm magpie.${submissiontype}-storm-${stormversion}-zookeeper-${zookeeperversion}-zookeeper-local
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-storm magpie.${submissiontype}-storm-${stormversion}-zookeeper-${zookeeperversion}-zookeeper-shared
	...
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-storm magpie.${submissiontype}-storm-${stormversion}-zookeeper-${zookeeperversion}-no-local-dir
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-storm magpie.${submissiontype}-storm-${stormversion}-zookeeper-${zookeeperversion}-zookeeper-local-no-local-dir
	cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-storm magpie.${submissiontype}-storm-${stormversion}-zookeeper-${zookeeperversion}-zookeeper-shared-no-local-dir
	...
	sed -i -e 's/export ZOOKEEPER_DATA_DIR="'"${lustredirpathsubst}"'\/zookeeper"/export ZOOKEEPER_DATA_DIR="'"${ssddirpathsubst}"'\/zookeeper\/"/' magpie.${submissiontype}-storm-${stormversion}-zookeeper-${zookeeperversion}*zookeeper-local*

	sed -i -e 's/export ZOOKEEPER_DATA_DIR_TYPE="networkfs"/export ZOOKEEPER_DATA_DIR_TYPE="local"/' magpie.${submissiontype}-storm-${stormversion}-zookeeper-${zookeeperversion}*zookeeper-local*
...
for zookeeperversion in 3.4.5 3.4.6
do
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-storm ./magpie.${submissiontype}-zookeeper-${zookeeperversion}
    ...
    cp ../submission-scripts/script-${submissiontype}/magpie.${submissiontype}-storm ./magpie.${submissiontype}-zookeeper-${zookeeperversion}-no-local-dir
    ...
    sed -i -e 's/export MAGPIE_JOB_TYPE="storm"/export MAGPIE_JOB_TYPE="zookeeper"/' magpie.${submissiontype}-zookeeper-${zookeeperversion}*
    ...
    sed -i -e 's/export ZOOKEEPER_MODE="launch"/export ZOOKEEPER_MODE="zookeeperruok"/' magpie.${submissiontype}-zookeeper-${zookeeperversion}*
    ...
    sed -i -e 's/export ZOOKEEPER_DATA_DIR="'"${lustredirpathsubst}"'\/zookeeper"/export ZOOKEEPER_DATA_DIR="'"${ssddirpathsubst}"'\/zookeeper\/"/' magpie.${submissiontype}-zookeeper-${zookeeperversion}-zookeeper-local* 

    sed -i -e 's/export ZOOKEEPER_DATA_DIR_TYPE="networkfs"/export ZOOKEEPER_DATA_DIR_TYPE="local"/' magpie.${submissiontype}-zookeeper-${zookeeperversion}-zookeeper-local* 
...
then
    ...
    sed -i -e "s/slurm-hbase-%j.out/slurm-hbase-zookeeper-shared-%j.out/" magpie.${submissiontype}-hbase*zookeeper*shared*
    ...
    sed -i -e "s/slurm-storm-%j.out/slurm-storm-zookeeper-shared-%j.out/" magpie.${submissiontype}-storm*zookeeper*shared*
...
then
    ...
    sed -i -e "s/moab-hbase-%j.out/moab-hbase-zookeeper-shared-%j.out/" magpie.${submissiontype}-hbase*zookeeper*shared*
    ...
    sed -i -e "s/moab-storm-%j.out/moab-storm-zookeeper-shared-%j.out/" magpie.${submissiontype}-storm*zookeeper*shared*
