...
then
    ...
    sed -i -e "s/slurm-hbase-%j.out/slurm-run-phoenixperformanceeval-%j.out/" magpie.${submissiontype}*run-phoenixperformanceeval*
...
then
    ...
    sed -i -e "s/moab-hbase-%j.out/moab-run-phoenixperformanceeval-%j.out/" magpie.${submissiontype}*run-phoenixperformanceeval*
