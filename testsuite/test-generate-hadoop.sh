...
# - hadoop 2.4.X does not have "Finalize upgrade success" phrase output when complete
    ...
    __GenerateHadoopDependencyTests_Dependency5 "5AB" "n" 3.3.0 3.3.1 3.3.2 3.3.3 3.3.4 3.3.5
...
# Dependency 6 test, detect newer hdfs version X from Y, HDFS over Lustre / NetworkFS
    ...
    __GenerateHadoopDependencyTests_DependencyDetectNewerHDFS "3.2.2" "3.2.3" "6AP"
    __GenerateHadoopDependencyTests_DependencyDetectNewerHDFS "3.2.3" "3.2.4" "6AQ"

    __GenerateHadoopDependencyTests_DependencyDetectNewerHDFS "3.3.0" "3.3.1" "6AR"
    __GenerateHadoopDependencyTests_DependencyDetectNewerHDFS "3.3.1" "3.3.2" "6AS"
    __GenerateHadoopDependencyTests_DependencyDetectNewerHDFS "3.3.2" "3.3.3" "6AT"
    __GenerateHadoopDependencyTests_DependencyDetectNewerHDFS "3.3.3" "3.3.4" "6AU"
    __GenerateHadoopDependencyTests_DependencyDetectNewerHDFS "3.3.4" "3.3.5" "6AV"
}
