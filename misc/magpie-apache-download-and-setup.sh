...
SPARK_PACKAGE="spark/spark-2.1.0/spark-2.1.0-bin-hadoop2.7.tgz"
SPARK_HADOOP_PACKAGE="hadoop/common/hadoop-2.7.3/hadoop-2.7.3.tar.gz"
STORM_PACKAGE="storm/apache-storm-1.0.3/apache-storm-1.0.3.tar.gz"
PHOENIX_PACKAGE="phoenix/apache-phoenix-4.10.0-HBase-1.2/bin/apache-phoenix-4.10.0-HBase-1.2-bin.tar.gz"
PHOENIX_HBASE_PACKAGE="hbase/1.2.4/hbase-1.2.4-bin.tar.gz"
KAFKA_PACKAGE="kafka/0.9.0.0/kafka_2.11-0.9.0.0.tgz"
ZEPPELIN_PACKAGE="zeppelin/zeppelin-0.7.0/zeppelin-0.7.0-bin-all.tgz"
