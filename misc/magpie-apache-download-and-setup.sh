...
HBASE_PACKAGE="hbase/1.4.7/hbase-1.4.7-bin.tar.gz"
...
SPARK_PACKAGE="spark/spark-2.3.2/spark-2.3.2-bin-hadoop2.7.tgz"
...
PHOENIX_HBASE_PACKAGE="hbase/1.4.7/hbase-1.4.7-bin.tar.gz"
