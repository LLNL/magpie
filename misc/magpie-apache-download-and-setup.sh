...
HADOOP_PACKAGE="hadoop/common/hadoop-2.8.1/hadoop-2.8.1.tar.gz"
HBASE_PACKAGE="hbase/1.3.1/hbase-1.3.1-bin.tar.gz"
PIG_PACKAGE="pig/pig-0.17.0/pig-0.17.0.tar.gz"
MAHOUT_PACKAGE="mahout/0.13.0/apache-mahout-distribution-0.13.0.tar.gz"
ZOOKEEPER_PACKAGE="zookeeper/zookeeper-3.4.10/zookeeper-3.4.10.tar.gz"
SPARK_PACKAGE="spark/spark-2.1.1/spark-2.1.1-bin-hadoop2.7.tgz"
...
PHOENIX_PACKAGE="phoenix/apache-phoenix-4.11.0-HBase-1.2/bin/apache-phoenix-4.11.0-HBase-1.3-bin.tar.gz"
PHOENIX_HBASE_PACKAGE="hbase/1.2.4/hbase-1.3.1-bin.tar.gz"
KAFKA_PACKAGE="kafka/0.9.0.0/kafka_2.11-0.9.0.0.tgz"
ZEPPELIN_PACKAGE="zeppelin/zeppelin-0.7.2/zeppelin-0.7.2-bin-all.tgz"
