...
HADOOP_PACKAGE="hadoop/common/hadoop-3.3.6/hadoop-3.3.6.tar.gz"
...
SPARK_PACKAGE="spark/spark-3.3.3/spark-3.3.3-bin-hadoop3.tgz"
SPARK_HADOOP_PACKAGE="hadoop/common/hadoop-3.3.6/hadoop-3.3.6.tar.gz"
