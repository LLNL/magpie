...
# Phoenix Version
#
export PHOENIX_VERSION="4.7.0-HBase-1.1"
...
#
export PHOENIX_HOME="${HOME}/phoenix-${PHOENIX_VERSION}-bin"
...
# $MAGPIE_SCRIPTS_HOME/conf/phoenix if of the files it needs are not
