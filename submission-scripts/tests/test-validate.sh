...
for file in `ls slurm-hadoop-terasort*`
do
...
for file in `ls slurm-hadoop-upgradehdfs*`
do
...
for file in `ls slurm-hadoop-hdfs-older-version*`
do
...
for file in `ls slurm-hadoop-hdfs-newer-version*`
do
...
for file in `ls slurm-hadoop-hdfs-fewer-nodes*`
do
...
for file in `ls slurm-spark-wordcount*`
do
...
for file in `ls slurm-zookeeper*`
do
